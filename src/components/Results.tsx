          ...
          <Reveal key={s.note} delay={(i % 2) * 0.1}>
            <figure className="group">
              ...
              <div className="hairline relative flex aspect-video items-center justify-center overflow-hidden border bg-stone-100 dark:bg-stone-900/50">
                <span className="absolute left-4 top-4 font-mono text-[11px] tracking-[0.2em] text-stone-400 dark:text-stone-500">
                  {s.ratio}
                </span>
                <span className="font-mono text-[11px] tracking-[0.24em] text-stone-400 dark:text-stone-500">
                  示例成片 · 待替换
                </span>
              </div>
              <figcaption className="mt-3 flex items-baseline justify-between">
                <span className="text-sm font-medium">{s.note}</span>
