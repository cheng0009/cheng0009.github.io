    ...
    <footer className="hairline border-t-2">
      <div className="mx-auto flex max-w-[1400px] flex-col gap-4 px-5 py-12 md:flex-row md:items-center md:justify-between md:px-10">
        <div className="flex items-center gap-4">
          <span className="flex h-9 w-9 items-center justify-center bg-ink font-display text-xl font-semibold text-white dark:bg-white dark:text-stone-600">
            2
          </span>
          <div>
            <p className="text-lg font-bold tracking-tight">知二IP</p>
        ...
        <div className="flex flex-col gap-2 md:items-end">
          <p className="font-display text-[15px] font-semibold tracking-[0.06em]">
            © 2026 知二IP
          </p>
