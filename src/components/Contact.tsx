          ...
          <div className="hairline grid grid-cols-2 border bg-stone-50 dark:bg-stone-950">
            ...
            <div className="hairline border-r p-6">
              <div className="flex aspect-square items-center justify-center border border-dashed border-stone-900/20 dark:border-white/20">
                <span className="px-2 text-center font-mono text-xs leading-relaxed tracking-[0.2em] text-stone-600 dark:text-stone-400">
                  微信二维码
                  <br />
                  待替换
                </span>
              </div>
              <p className="mt-4 text-center text-base font-medium">个人微信</p>
              <p className="mt-1 text-center font-mono text-xs tracking-[0.16em] text-stone-600 dark:text-stone-400">
                备注「知二」
              </p>
            </div>
            {/* TODO: 替换为真实公众号二维码图片 */}
            <div className="p-6">
              ...
              <p className="mt-4 text-center text-base font-medium">公众号</p>
              <p className="mt-1 text-center font-mono text-xs tracking-[0.16em] text-stone-600 dark:text-stone-400">
                内容方法论持续更新
              </p>
            </div>
