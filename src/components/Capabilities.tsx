      ...
      <div className="mt-16 grid gap-5 md:grid-cols-12">
        ...
        <Reveal className="md:col-span-8">
          <div className="hairline h-full border bg-orange-50/70 p-8 md:p-10 dark:bg-orange-950/25">
            <div className="flex items-baseline justify-between">
              ...
              <span className="font-mono text-[11px] tracking-[0.18em] text-stone-500 dark:text-stone-400">
                脚本层
              </span>
            </div>
            <h3 className="mt-8 text-xl font-medium tracking-tight">四套脚本模板</h3>
            <p className="mt-3 max-w-[46ch] text-[15px] leading-relaxed text-stone-600 dark:text-stone-400">
            ...
            <div className="mt-8 grid grid-cols-2 gap-3 md:grid-cols-4">
              {[
                ...
                >
                  <p className="font-mono text-[11px] tracking-[0.2em] text-orange-700 dark:text-orange-400">
                    {code}
                  </p>
          ...
          <div className="hairline hairline flex h-full flex-col border bg-stone-100 p-8 dark:bg-stone-900/40">
            ...
            <div className="mt-6 flex flex-1 flex-col">
              ...
              <div className="hairline relative flex flex-1 items-center justify-center border border-dashed bg-stone-50 dark:bg-stone-950/50">
                <span className="font-mono text-[11px] tracking-[0.2em] text-stone-400 dark:text-stone-500">
                  小黑 · IP 形象
                </span>
              </div>
              <div className="mt-6">
        ...
        <Reveal className="md:col-span-4">
          <div className="hairline h-full border bg-stone-50 p-8 dark:bg-stone-900/40">
            ...
            <h3 className="mt-8 text-xl font-medium tracking-tight">五种视觉模式</h3>
        ...
        <Reveal delay={0.1} className="md:col-span-4">
          <div className="hairline h-full border bg-stone-50 p-8 dark:bg-stone-900/40">
            ...
            <h3 className="mt-8 text-xl font-medium tracking-tight">一键多平台发布</h3>
            <p className="mt-3 text-[15px] leading-relaxed text-stone-600 dark:text-stone-400">
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              {PLATFORMS.map((p) => (
                <span
                  key={p}
                  className="hairline border px-3 py-1.5 text-xs text-stone-600 dark:text-stone-400"
                >
                  {p}
                </span>
              ))}
        ...
        <Reveal className="md:col-span-4">
          <div className="hairline h-full border bg-stone-50 p-8 dark:bg-stone-900/40">
            ...
            <h3 className="mt-8 text-xl font-medium tracking-tight">全本地部署</h3>
            <p className="mt-3 text-[15px] leading-relaxed text-stone-600 dark:text-stone-400">
        ...
        <Reveal delay={0.1} className="md:col-span-4">
          <div className="hairline h-full border bg-stone-50 p-8 dark:bg-stone-900/40">
            ...
            <h3 className="mt-8 text-xl font-medium tracking-tight">版权与数据归你</h3>
            <p className="mt-3 text-[15px] leading-relaxed text-stone-600 dark:text-stone-400">
